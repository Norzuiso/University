...
void showMenu(char menuOption);

float interes(float principal, int tiempo);

void function_interes();
...
void function_interes() {
    float principal = 0;
    int tiempo= 0;
    printf("Opcion 7 %s", line);
    printf("Interes compuesto\n");
    printf("Ingresa cuantos anios a invertir: \n");
    scanf("%i", &tiempo);
    printf("Ingresa el monto inicial a invertir: \n");
    scanf("%f", &principal);
    interes(principal, tiempo);
}
